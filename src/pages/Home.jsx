    ...
    <Layout>
      ...
      <Content className="content">
        <Row justify="start" gutter={[16, 16]}>
          {/* Profile */}
          <Col xs={{ order: 2, span: 24 }} sm={{ order: 2, span: 24 }} md={{ order: 1, span: 8 }} lg={{ order: 2, span: 6 }} xl={{ order: 2, span: 6 }} xxl={{ order: 1, span: 6 }}>
          ...
          {/* Project Highlight */}
          <Col xs={{ order: 1, span: 24 }} sm={{ order: 4, span: 24 }} md={24} lg={24} xl={16} xxl={16}>
